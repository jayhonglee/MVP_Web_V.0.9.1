    ...
    <div className="w-full">
      ...
      {(!groupChats || groupChats.length === 0) && (
        <div className="w-full flex flex-col justify-center items-center pt-[30vh]">
          ...
          <p className="text-[16px] mobile:text-[20px] font-[500] leading-[24px] mobile:leading-[28px] tracking-[-0.25px] text-[rgb(185,182,182)] text-center">
            Create or join a hangout to start chatting!
          </p>
        </div>
      )}
